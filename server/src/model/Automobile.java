...
public class Automobile implements Serializable { 
	...
	public ArrayList<String> getOptionSetList() {
		...
		for (OptionSet opset : opsets) {
			list.add(opset.getName());
		}
		return list;
	}

	public ArrayList<String> getOptionList(String opsetName) {
		ArrayList<String> list = new ArrayList<String>();
		OptionSet opset = getOptionSet(opsetName);
		if (opset != null) {
	...
	public ArrayList<Float> getOptionPriceList(String opsetName) {
		ArrayList<Float> list = new ArrayList<Float>();
		OptionSet opset = getOptionSet(opsetName);
		if (opset != null) {
			for (Option opt : opset.getOpt()) {
				list.add(opt.getPrice());
			}
		}
		return list;
	}
